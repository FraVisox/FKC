...
//It is the same as KPELLCAPP, but uses GuessVAL instead of Guess
public class KPELLCAPPVAL implements Algorithm
{
    public KPELLCAPPVAL(double _beta, int[] _ki) {
        beta = _beta;
        ki = _ki;
