...
//It is the same as CAPP, but uses GuessVAL instead of Guess
public class CAPPVAL implements Algorithm {

    public CAPPVAL(int[] _ki, double _beta, double _minDist, double _maxDist) {
        ...
        guesses = new GuessVAL[number_of_guesses];
        ...
        for (int i = 0; i<number_of_guesses; i++) {
            guesses[i] = new GuessVAL(gamma, _ki);
            gamma *= (1+_beta);
        }
    }
    ...
    //Array of guesses
    private final GuessVAL[] guesses;
}
