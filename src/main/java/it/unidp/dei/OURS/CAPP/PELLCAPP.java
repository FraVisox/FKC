...
//Algorithm of Ours oblivious to the aspect ratio thanks to the PELLDiameter algorithm.
//It uses Guess class.
public class PELLCAPP implements Algorithm
{
    public PELLCAPP(double _beta, double _eps, int[] _ki) {
        beta = _beta;
