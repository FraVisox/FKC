package it.unidp.dei.OURS.CAPP;

import it.unidp.dei.Algorithm;
import it.unidp.dei.OURS.Utils.Diameter.COHENDiameter;
import it.unidp.dei.OURS.Utils.Guess.Guess;
import it.unidp.dei.OURS.Utils.Guess.KCGuess;
...
//Algorithm of Ours oblivious to the aspect ratio thanks to the COHENDiameter algorithm.
//It uses KCGuess class.
public class KCOHCAPP implements Algorithm
{
    public KCOHCAPP(double _beta, double _eps, int[] _ki) {
        beta = _beta;
    ...
    //Utility function to create R for a certain gamma
