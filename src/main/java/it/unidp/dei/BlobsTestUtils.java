...
public class BlobsTestUtils {
    ...
    private static final int[] blobsDatasetsDimensions = {2,3,4,5,6,7,8,9,10};
    ...
    private static final double[] blobsMinDist = {1.57e-5, 0.002, 0.007, 0.048, 0.11, 0.18, 0.38, 0.49, 0.65};
    private static final double[] blobsMaxDist = {132.2, 145.2, 169.2, 163.1, 170.1, 192.7, 199.5, 193.8, 208.7};
